...
using NetFlask.DAL;
using NetFlask.PocADO;
using System.Data;
using System.Data.Common;

Console.WriteLine("POC ADO");

#region Poc (prove of concepts) de refresh pour l'insertion de données en ADO -- verifier si ce que je pense est faisable
////1- Nuget Microsoft.Data.SqlClient

////2- Connectionstring
//string cnstr = @"Data Source=GOS-VDI206\TFTIC;Initial Catalog=NetFlask;Integrated Security=True;Connect Timeout=60;Encrypt=False;Trust Server Certificate=False;";
